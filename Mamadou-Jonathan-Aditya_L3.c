...
char UARTX_recv(){
	char rcvChar;
	//char rcvChar = '\0';		//Variable to hold the reciving byte data
	/*
	while(){
		rcvChar = getChar(uartOne);
		writeDebugStream("rcvchar is: ", rcvChar);
	}
	*/
	//while (true)
	//{
		...
		/*if (rcvChar == -1)
		{
			writeDebugStream("rcvchar if it is == -1", rcvChar);
			//printf("<%c>", rcvChar);
		...
		if(rcvChar == 1)
		{
			writeDebugStream("rcvchar if it !=", rcvChar);
			//motor[rightMotor] = 65;
			//motor[leftMotor] = 65;
		}*/
	//}
